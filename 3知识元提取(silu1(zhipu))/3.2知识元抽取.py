...
def main(file_path):
    ...
    df.to_excel(r"C:\Users\hhhxj\Desktop\专利数据\4抽取的知识元\greater_than_10_years_unit(10).xlsx", index=False)
    print("所有专利摘要处理完成，结果已保存")


# 运行主函数，传入Excel文件路径
if __name__ == "__main__":
    file_path = r"C:\Users\hhhxj\Desktop\专利数据\2抽取数据\greater_than_10_years.xlsx"  # 替换为你的Excel文件路径
    main(file_path)
