...
def main(file_path):
    ...
    # 保存结果为 Excel 文件
    result_df.to_excel(r"C:\Users\hhhxj\Desktop\专利数据\5向量化\vectorized_greater_than_or_equal_10_years_unit(10)(去除空值).xlsx",
                       index=False)
    print("处理完成，结果已保存！")


if __name__ == '__main__':
    file_path = r"C:\Users\hhhxj\Desktop\专利数据\4抽取的知识元\greater_than_10_years_unit(10)(去除空值).xlsx"
    main(file_path)
